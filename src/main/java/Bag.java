...
public abstract class Bag {
    ...
    public Bag(String color, int capacity) {
        ...
        this.contents = new String[capacity]; /* Because the size of the content array is its capacity */
    }
    ...
    public String popItem(){
        if (this.numberOfContents == 0) {
            ...
            String[] new_bag = new String[numberOfContents - 1];
            for (int i = 0; i < (this.numberOfContents - 1); i++) {
                new_bag[i] = this.contents[i];
            }
            String popped_item = this.contents[numberOfContents - 1];
            this.contents = new_bag;
